...
if (!class_exists('aione_theme_options')) {

    class aione_theme_options {
        ...
        public function setSections() {
            ...
            function getImageFiles($directory, $thumbnail = false){
                ...
                $backgrounds_path = AIONE_PLUGIN_PATH. '/assets/images/'.$directory.'/'.$thumbnail_directory;
                $backgrounds_url = AIONE_PLUGIN_URL. '/assets/images/'.$directory.'/'.$thumbnail_directory;
            ...
            **/
			...
			function aione_get_sidebars(){
				$sidebar_options[] = 'None';
				for($i=0;$i<1;$i++){
					$sidebars = wp_get_sidebars_widgets();// sidebar_generator::get_sidebars();
					//var_dump($sidebars);
            ...
            **/
			...
			require_once(dirname(__FILE__). '/options/design_social_media.php');
            require_once(dirname(__FILE__). '/options/design_footer.php');
			require_once(dirname(__FILE__). '/options/design_sidebars.php');
            require_once(dirname(__FILE__). '/options/design_typography.php');
            require_once(dirname(__FILE__). '/options/design_color.php');
            require_once(dirname(__FILE__). '/options/design_backgrounds.php');
            require_once(dirname(__FILE__). '/options/design_blog.php');
           
            require_once(dirname(__FILE__). '/options/design_security.php');
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'admin_bar_icon' => 'dashicons-image-filter',
                'allow_sub_menu' => true,
...
'),
    ...
    global $reduxConfig;
    $reduxConfig = new aione_theme_options();
