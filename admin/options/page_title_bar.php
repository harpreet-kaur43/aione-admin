...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array(
            ...
            'type'     => 'color',
            'title'    => __('Page Title Bar Heading Color', 'redux-framework-demo'), 
            'subtitle' => __('Select a color for Heading on page title bar.', 'redux-framework-demo'),
            'desc' => __('Default color is #333c44. Mark tick for title bar text color transparent. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes.', 'redux-framework-demo'),
            'default'  => '#333c44',
            'validate' => 'color',
            'required' => array('page_title_bar_customize_enable','equals','1'),
        ),
        array(
			...
			'desc' => __('Default color is #49525a. Mark tick for title bar text color transparent. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes.', 'redux-framework-demo'),
            'default'  => '#49525a',
            'validate' => 'color',
            'required' => array('page_title_bar_customize_enable','equals','1'),
        ),
        ...
        array(
			...
			'desc' => __('Default color is #49525a. Mark tick for title bar link color transparent. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes.', 'redux-framework-demo'),
            'default'  => '#49525a',
            'validate' => 'color',
            'required' => array('page_title_bar_customize_enable','equals','1'),
        ),
        array(
			...
			'desc' => __('Default color is #333c44. Mark tick for title bar link hover color transparent. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes.', 'redux-framework-demo'),
            'default'  => '#333c44',
            'validate' => 'color',
            'required' => array('page_title_bar_customize_enable','equals','1'),   
        ),
